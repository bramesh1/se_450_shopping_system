            ...
            switch (choice) {
                ...
                case 2:
                    if(loginUser(scanner));{
                    	//String username = getUsernameFromLogin(scanner); // Assuming a method to get username from login
                        //browseCatalog(username); // Pass the username
                    	break;
                    }
        ...
        static void addToCartOrRemoveFromCart(CartManager cartManager, Scanner scanner, ProductType type) {
            ...
            if (!cartManager.getCart().getItems().isEmpty() && choice.equals("N")) {
                ...
                if (response.equals("Y")) {
                    ...
                    // Call createOrder with the provided name and address
