...
public class CartManager {
	 ...
	 * System.out.println("Enter your name:"); String customerName =
	 * scanner.nextLine(); System.out.println("Enter your address:"); String
	 * customerAddress = scanner.nextLine();
	 * 
	 * Order order = new Order(); order.setCustomerName(customerName);
	 * order.setCustomerAddress(customerAddress); for (Product item :
	 * cart.getItems()) { order.addItem(item); } orderProcessor.placeOrder(order);
	 * orderProcessor.finalizeOrder(order); cart.clearCart();
	 * 
	 * return order; }
	 */
    public void createOrder(String customerName, String customerAddress) {
        ...
        //orderProcessor.finalizeOrder(order);
        cart.clearCart();
    }
}
